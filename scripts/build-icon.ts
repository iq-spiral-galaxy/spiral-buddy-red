...
//   2. SVG 문자열 생성 (deep maroon + crimson + warm coral/gold)
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 ${SIZE} ${SIZE}" width="${SIZE}" height="${SIZE}">
  <!-- Spiral Buddy Red icon: deep maroon + crimson + coral/gold 나선형 -->
  <defs>
    <linearGradient id="bg" x1="0%" y1="0%" x2="100%" y2="100%">
      <stop offset="0%" stop-color="#57262e"/>
      <stop offset="45%" stop-color="#cb5a64"/>
      <stop offset="100%" stop-color="#261013"/>
    </linearGradient>
    <radialGradient id="glow" cx="58%" cy="62%" r="62%">
      <stop offset="0%"  stop-color="#ffcf9d" stop-opacity="0.46"/>
      <stop offset="38%" stop-color="#f18c5e" stop-opacity="0.24"/>
      <stop offset="72%" stop-color="#cc785c" stop-opacity="0.06"/>
      <stop offset="100%" stop-color="#cc785c" stop-opacity="0"/>
    </radialGradient>
    <radialGradient id="coolGlow" cx="32%" cy="24%" r="62%">
      <stop offset="0%" stop-color="#ffd98c" stop-opacity="0.1"/>
      <stop offset="58%" stop-color="#ffd98c" stop-opacity="0.025"/>
      <stop offset="100%" stop-color="#ffd98c" stop-opacity="0"/>
    </radialGradient>
    ...
    <linearGradient id="spiralStroke" x1="18%" y1="4%" x2="83%" y2="96%">
      ...
      <stop offset="42%"  stop-color="#fff7f3"/>
