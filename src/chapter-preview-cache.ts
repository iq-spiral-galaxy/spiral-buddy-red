...
응답 스키마:
{
  "summary": "한 문장. 이 챕터에서 다루는 핵심을 60자 이내로. 예: 'SVD의 존재성 증명과 저랭크 근사(Eckart-Young)'",
  "keyQuestions": ["이 챕터를 읽으면 답할 수 있게 되는 핵심 질문 2~3개. 각 80자 이내", "..."],
  "prerequisites": "이 챕터 이해에 필요한 사전 지식 한 줄. 없거나 자명하면 null"
}

카드는 플레인 텍스트로 표시된다 — LaTeX 마크업($...$, \\frac 등)을 쓰지 말고 수식은 말이나 일반 표기(예: "A = QΛQ^T", "O(n^3)")로 풀어 쓸 것.
