...
// env로 주입 가능: 기본 "spiral-buddy-red", 다른 방은 "spiral-buddy-red-<id>" 등.
// (Blue의 "spiral-buddy"와 다른 기본값 — 같은 vault를 써도 노트가 섞이지 않게)
...
async function updateIndex(
  ...
  try {
    ...
    existing = [
      "---",
      "title: spiral-buddy-red index",
      "generator: spiral-buddy-red",
      "---",
      "",
      "# Sessions",
      "",
...
/**
 * 노트들을 vault의 현재 workspace 하위 폴더에 있는 .trash/로 이동.
...
/**
 * .trash/ 안 파일을 현재 workspace의 노트 폴더로 되돌린다.
...
/**
 * 현재 workspace의 .trash/ 안에서 mtime이 maxAgeDays보다 오래된 파일 영구 삭제.
